...
public struct MarkdownRenderingOptions: Sendable {
    ...
    public var hasEnhancedFeatures: Bool {
        syntaxHighlighting.isEnabled || tableOfContents.isEnabled || codeBlocks.copyButton || codeBlocks.lineNumbers || codeBlocks.showFileName || codeBlocks.runButton
            || mathSupport.isEnabled
    }

    /// Returns a copy of the options with modified syntax highlighting
    public func withSyntaxHighlighting(_ syntaxHighlighting: SyntaxHighlighting) -> MarkdownRenderingOptions {
